...
\newpage
    ...
    \section{Week 3}
        ...
        \subsection{Thursday}
            \begin{itemize}
                \item How can we read texts ``closely''?
                \begin{itemize}
                    \item Read repeatedly
                    \item Avoid answering questions about the ``meaning'' of texts right away. Texts take time to digest
                    \item you cannot skim. Go word by word, letter by letter
                    \item read with a pencil (analog or digital)
                    \item patterns, look for them
                    \item take time during. Take time between
                    \item the more you do this, the more fluent you get
                \end{itemize} 
                \item Negotiating w/ Trifles
                \begin{itemize}
                    \item What is ``incomplete'' about this play?
                    \item What do the words ``deny'' you?
                    \item What is the ``form'' of this play?
                    \item How could you realize it on a page like Parks' ``equations''?
                    \item Who is the protagonist of \textit{Trifles}?
                \end{itemize}
                \end{itemize}
            \end{itemize}
\end{document}